...
from app.schemas import EventBatchAccepted, EventBatchIn
...
async def ingest_batch(
    ...
    rows = [
        to_row(e, user_id=user.id if user else None, anon_id=anon_id, path_fallback="")
    ...
    return EventBatchAccepted(accepted=accepted)
